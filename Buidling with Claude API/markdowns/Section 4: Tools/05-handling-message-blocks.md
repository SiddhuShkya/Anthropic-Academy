...
> Video Link: [Handling Message Blocks](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287757)
...
<img src="../../../images/Builiding-With-Claude-API/tool-use/multi-block-messages.png" alt="image" width="100%"/>
