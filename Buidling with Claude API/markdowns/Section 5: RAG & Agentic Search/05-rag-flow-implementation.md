...
> Video Link : [RAG Flow Implementation](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287761)
...
<img src="../../../images/Builiding-With-Claude-API/RAG/closest-vector.png" alt="image" width="100%"/>
...
```python
generate_embedding("What did the software engineering dept do last year?")
```
