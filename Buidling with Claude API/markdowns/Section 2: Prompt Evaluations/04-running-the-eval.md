...
> Video Link: [Running the eval](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287743)
...
<img src="../../../images/Builiding-With-Claude-API/prompt-evaluation/running-the-eval.png" alt="image" width="100%"/>
...
## The run_all_prompts Function
This function orchestrates the evaluation by iterating through the entire dataset and collecting results:
...
<img src="../../../images/Builiding-With-Claude-API/prompt-evaluation/examining-results.png" alt="image" width="100%"/>
...
<img src="../../../images/Builiding-With-Claude-API/prompt-evaluation/verbose-responses.png" alt="image" width="100%"/>
