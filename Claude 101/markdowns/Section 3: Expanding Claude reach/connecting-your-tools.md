...
1. Download and install the [Claude Desktop App](https://claude.com/download)
...
For more information on connectors and the Model Context Protocol, visit the [Anthropic Help Center](https://support.claude.com/en/articles/11176164-use-connectors-to-extend-claude-s-capabilities) or explore the connector directory at claude.ai/directory.
