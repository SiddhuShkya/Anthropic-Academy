...
- [AI Fluency courses](https://www.anthropic.com/ai-fluency) – Free courses on effective AI collaboration
- [AI Capabilities and Limitations](https://anthropic.skilljar.com/ai-capabilities-and-limitations) – Free introductory course on what AI can and can't do
- [Use Case Gallery](https://claude.com/resources/use-cases) – Step-by-step guides and prompts for powerful workflows
- [Anthropic Help Center](https://support.anthropic.com/) – Detailed documentation and troubleshooting
- [Prompting documentation](https://docs.claude.com/en/docs/build-with-claude/prompt-engineering/overview) – Comprehensive guide to getting the best results

**Product-specific resources**

- [Claude Code in Action](https://anthropic.skilljar.com/claude-code-in-action) – Free course on using Claude for development workflows
- [Introduction to Claude Cowork](https://anthropic.skilljar.com/introduction-to-claude-cowork) – Free course on how to use Claude's desktop companion for multi-step work
- [Connector Directory](https://claude.com/connectors) – Browse and connect your tools
